...
import { LayoutDashboard, FileText, ClipboardCheck, Users, X, MessageSquare, LogOut, ClipboardList, Layers, Database } from 'lucide-react';
...
const MobileSidebar = ({ isOpen, onClose }: MobileSidebarProps) => {
  ...
  const { canViewDashboard, canViewCustomers, canViewTemplates, canViewResources } = useAuth();
  ...
  const allLinks = [
    ...
    { href: '/resources', label: 'Resources', icon: Database, visible: canViewResources },
  ];
