...
export function getAQLLimitValue(sampleSize: number, aqlLevel: string | number): number {
  ...
  const aqlTable: Record<string, number> = {
    '2-1.5': 0, '2-2.5': 0, '2-4.0': 0,
    '3-1.5': 0, '3-2.5': 0, '3-4.0': 0,
    '5-1.5': 0, '5-2.5': 0, '5-4.0': 0,
    '8-1.5': 0, '8-2.5': 0, '8-4.0': 1,
    '13-1.5': 0, '13-2.5': 1, '13-4.0': 1,
    '20-1.5': 1, '20-2.5': 1, '20-4.0': 2,
    '32-1.5': 1, '32-2.5': 2, '32-4.0': 3,
    '50-1.5': 2, '50-2.5': 3, '50-4.0': 5,
    '80-1.5': 3, '80-2.5': 5, '80-4.0': 7,
    '125-1.5': 5, '125-2.5': 7, '125-4.0': 10,
    '200-1.5': 7, '200-2.5': 10, '200-4.0': 14,
    '315-1.5': 10, '315-2.5': 14, '315-4.0': 21,
    '500-1.5': 14, '500-2.5': 21, '500-4.0': 21,
    '800-1.5': 21, '800-2.5': 21, '800-4.0': 21,
    '1250-1.5': 21, '1250-2.5': 21, '1250-4.0': 21,
  };
